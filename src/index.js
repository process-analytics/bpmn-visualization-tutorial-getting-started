...
function getActivitiesMonitoringData() {
  ...
  activitiesMonitoringData.set("assignApprover", [700, 5, 0, 0]);
  activitiesMonitoringData.set("approveInvoice", [650, 2, 3, 0]);
  activitiesMonitoringData.set("reviewInvoice", [300, 4, 1, 2]);
